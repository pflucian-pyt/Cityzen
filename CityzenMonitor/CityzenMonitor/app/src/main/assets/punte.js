...
(function () {
  ...
  /* Puntea poate fi inregistrata sub trei nume, dupa versiunea aplicatiei:
     "Punte" la cele vechi, "PunteBle" sau "PunteSpp" la cele noi. Se cauta
     toate trei, ca o pagina noua sa mearga si intr-un APK vechi, si invers. */
  if (!window.Punte) window.Punte = window.PunteSpp || window.PunteBle;
